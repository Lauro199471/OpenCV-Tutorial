...
int main(int argc, char* argv[])
{
    ...
    String window_name_of_video_blurred_with_25x25_kernel = "Video Blurred with 25 x 25 Kernel";
    ...
    namedWindow(window_name_of_video_blurred_with_25x25_kernel, WINDOW_NORMAL);
    ...
    while (true)
    {
        ...
        Mat frame_blurred_with_25x25_kernel;
        
        blur(frame, frame_blurred_with_5x5_kernel, Size(5, 5));
        blur(frame, frame_blurred_with_25x25_kernel, Size(25, 25));
        ...
        imshow(window_name_of_video_blurred_with_25x25_kernel, frame_blurred_with_25x25_kernel);
